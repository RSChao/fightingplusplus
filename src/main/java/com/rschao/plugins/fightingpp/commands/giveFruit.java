...
public class giveFruit {
    ...
    public static CommandAPICommand aitor(){
        CommandAPICommand cmd = new CommandAPICommand("AitorAitor")
                .withPermission("fruits.give")
                .executesPlayer((exec, args) ->{
                    exec.getInventory().addItem(fruits.AitorFruit);
                });
        return cmd;
    }
    public static CommandAPICommand parrado(){
        CommandAPICommand cmd = new CommandAPICommand("ParradoParrado")
                .withPermission("fruits.give")
                .executesPlayer((exec, args) ->{
                    exec.getInventory().addItem(fruits.parraFruit);
                });
        return cmd;
    }
    ...
    public static CommandAPICommand shadow(){
        CommandAPICommand cmd = new CommandAPICommand("YoruKami")
                .withPermission("fruits.give")
                .executesPlayer((exec, args) ->{
                    exec.getInventory().addItem(fruits.YoruFruit);
                });
        return cmd;
    }
