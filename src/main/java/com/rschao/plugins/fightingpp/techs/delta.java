...
public class delta {
    ...
    static Technique windSword = new Technique(
        "wind_sword",
        "Wind sword",
        new TechniqueMeta(false, cooldownHelper.secondsToMiliseconds(30), List.of("Wind sword")),
    ...
    static Technique negate = new Technique(
        "negate",
        "NEGATE",
        new TechniqueMeta(false, cooldownHelper.secondsToMiliseconds(300), List.of("NEGATE")),
        TargetSelectors.self(),
        (ctx, token) -> {
            Player player = ctx.caster();
    ...
    static Technique dragonOnslaught = new Technique(
        "dragon_onslaught",
        "Dragon onslaught",
        new TechniqueMeta(false, cooldownHelper.secondsToMiliseconds(60), List.of("Dragon onslaught")),
        TargetSelectors.self(),
        (ctx, token) -> {
            Player player = ctx.caster();
    ...
    static Technique conquerorsHaki = new Technique(
        "conquerors_haki",
        "Conqueror's Haki",
        new TechniqueMeta(false, cooldownHelper.secondsToMiliseconds(300), List.of("Conqueror's Haki")),
        TargetSelectors.self(),
        (ctx, token) -> {
            Player player = ctx.caster();
    ...
    static Technique zoltraakBarrage = new Technique(
        "zoltraak",
        "Zoltraak",
        new TechniqueMeta(false, cooldownHelper.minutesToMiliseconds(2), List.of("Zoltraak")),
        TargetSelectors.self(),
        (ctx, token) -> {
            Player player = ctx.caster();
    ...
    static Technique wrathOfElementalGod = new Technique(
        "wrath_of_elemental_god",
        "Wrath of the Elemental God",
        new TechniqueMeta(true, cooldownHelper.secondsToMiliseconds(3600), List.of("Wrath of the Elemental God")),
        TargetSelectors.self(),
        (ctx, token) -> {
            Player player = ctx.caster();
    ...
    static Technique tornado = new Technique(
        "tornado",
        "Tornado",
        new TechniqueMeta(true, cooldownHelper.hour, List.of("Tornado")),
        TargetSelectors.self(),
        (ctx, token) -> {
            Player player = ctx.caster();
            Player user = player;
            ...
            TornadoEffect effect = new TornadoEffect(Plugin.getEffectManager());
            effect.setLocation(center);
            effect.tornadoHeight = 5;
            new BukkitRunnable() {
                int tick = 0;
